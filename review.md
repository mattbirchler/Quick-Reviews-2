...
The first would be to let me end the workout and delete the last X minutes since it thinks I stopped actually working out. The other would be to end the workout like normal, but then let me go into the Fitness app on my iPhone a trim the workout time just like I can trim a video in the Photos app.
